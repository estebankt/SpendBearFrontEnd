...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-text-main antialiased selection:bg-primary selection:text-white">
        <Auth0Provider>
          {children}
        </Auth0Provider>
      </body>
